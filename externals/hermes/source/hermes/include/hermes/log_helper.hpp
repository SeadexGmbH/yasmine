...
#ifndef LOG_HELPER_F1630103_70EA_469C_B378_32955DA9A018
#define LOG_HELPER_F1630103_70EA_469C_B378_32955DA9A018
...
class log_helper SX_FINAL
{
public:
	log_helper( const std::string& _file_name, const int _line );
	~log_helper() SX_NOEXCEPT;
	SX_NO_COPY( log_helper )
	...
	template< typename _parameter_type1, typename _parameter_type2, typename _parameter_type3, typename _parameter_type4 >
	void log( const log_level& _level, const std::string& _message, _parameter_type1 _value1,
	...
	template< typename _parameter_type1, typename _parameter_type2, typename _parameter_type3, typename _parameter_type4, 
		typename _parameter_type5, typename _parameter_type6 >
	void log( const log_level& _level, const std::string& _message, _parameter_type1 _value1,
	...
	template< typename _parameter_type1, typename _parameter_type2, typename _parameter_type3, typename _parameter_type4,
		typename _parameter_type5, typename _parameter_type6, typename _parameter_type7 >
		void log( const log_level& _level, const std::string& _message, _parameter_type1 _value1,
			_parameter_type2 _value2, _parameter_type3 _value3, _parameter_type4 _value4, _parameter_type5 _value5,
	...
	template< typename _parameter_type1, typename _parameter_type2, typename _parameter_type3, typename _parameter_type4,
		typename _parameter_type5, typename _parameter_type6, typename _parameter_type7, typename _parameter_type8 >
		void log( const log_level& _level, const std::string& _message, _parameter_type1 _value1,
			_parameter_type2 _value2, _parameter_type3 _value3, _parameter_type4 _value4, _parameter_type5 _value5,
			_parameter_type6 _value6, _parameter_type7 _value7, _parameter_type8 _value8 ) const
	{
		...
		{
			l_log_manager.log( _level, log_manager::get_instance().get_timestamp(), file_name_, line_, _message, 
				_value1, _value2, _value3, _value4, _value5, _value6, _value7, _value8 );
		}
	}
	...
	template< typename _parameter_type1, typename _parameter_type2, typename _parameter_type3, typename _parameter_type4,
		typename _parameter_type5, typename _parameter_type6, typename _parameter_type7, typename _parameter_type8,
		typename _parameter_type9, typename _parameter_type10 >
		void log( const log_level& _level, const std::string& _message, _parameter_type1 _value1,
			_parameter_type2 _value2, _parameter_type3 _value3, _parameter_type4 _value4, _parameter_type5 _value5,
	...
	template< typename _parameter_type1 >
	void log_and_wait( const log_level& _level, const std::string& _message, _parameter_type1 _value1 ) const
	{
		log_manager_template<std_timestamp_policy>& l_log_manager = log_manager::get_instance();
		if( _level <= l_log_manager.get_log_level() )
		{
			l_log_manager.log_and_wait( _level, log_manager::get_instance().get_timestamp(), file_name_, line_, _message,
				_value1 );
		}
	}
	...
	template< typename _parameter_type1, typename _parameter_type2 >
	void log_and_wait( const log_level& _level, const std::string& _message, _parameter_type1 _value1,
		_parameter_type2 _value2 ) const
	{
		log_manager_template<std_timestamp_policy>& l_log_manager = log_manager::get_instance();
		if( _level <= l_log_manager.get_log_level() )
		...
		_parameter_type2 _value2, _parameter_type3 _value3, _parameter_type4 _value4 ) const
	{
		...
		if( _level <= l_log_manager.get_log_level() )
		{
			l_log_manager.log_and_wait( _level, log_manager::get_instance().get_timestamp(), file_name_, line_, _message, _value1,
				_value2, _value3, _value4 );
		}
	}
