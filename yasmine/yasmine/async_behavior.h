...
public:
	async_behavior();
	virtual ~async_behavior();
	async_behavior( const async_behavior& ) = delete;
	async_behavior& operator=( const async_behavior& ) = delete;

	void start( const event& _event, const simple_state_base* const _simple_state, async_event_handler& _async_event_handler );
	void stop();		
...
private:	
	void run( const event& _event, const simple_state_base* const _simple_state, async_event_handler& _async_event_handler );
