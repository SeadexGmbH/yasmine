...
t_history::t_history( const std::string& p_name )
...
t_history::~t_history() = default;


t_raw_transitions t_history::get_default_transitions() const
{
...
void t_history::add_default_transition( i_transition& p_default_transition )
{
	t_vertex::add_outgoing_transition( p_default_transition );
}


bool t_history::check_if_state_was_active_before() const
{
