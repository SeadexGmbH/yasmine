...
t_state_machine_defect::~t_state_machine_defect() = default;


// cppcheck-suppress unusedFunction
const i_state_machine_element& t_state_machine_defect::get_element() const
{
	return( *m_element );
}


const std::string& t_state_machine_defect::get_message() const
{
	return( m_message );
}
