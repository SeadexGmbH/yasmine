...
class t_execution_state_exit_step final:
	public i_execution_step
{
public:
	explicit t_execution_state_exit_step( i_state& p_state );
	virtual ~t_execution_state_exit_step() override;
	t_execution_state_exit_step( const t_execution_state_exit_step& ) = delete;
	t_execution_state_exit_step& operator=( const t_execution_state_exit_step& ) = delete;
