...
class t_fork final:
	public virtual i_fork, public t_region_pseudostate
{
public:
	explicit t_fork( const std::string& p_name );
	virtual ~t_fork() override;
	t_fork( const t_fork& ) = delete;
	t_fork& operator=( const t_fork& ) = delete;
