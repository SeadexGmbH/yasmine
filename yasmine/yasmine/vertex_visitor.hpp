...
{
public:
	vertex_visitor() = default;
	virtual ~vertex_visitor() noexcept = default;
	vertex_visitor( const vertex_visitor& ) = delete;
	vertex_visitor& operator=( const vertex_visitor& ) = delete;
