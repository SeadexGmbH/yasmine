...
t_compound_transition_step::t_compound_transition_step
(
	const t_raw_transitions& p_transitions
):
	i_transition_step(),
...
t_compound_transition_step::get_transitions
(
) const
{
...
const i_vertex&
t_compound_transition_step::get_unique_source
(
) const
{
...
const i_vertex&
t_compound_transition_step::get_unique_target
(
) const
{
	const auto unique_transition = m_transitions.front();
...
const i_exit_point*
t_compound_transition_step::get_exit_point
(
) const
{
...
const i_entry_point*
t_compound_transition_step::get_entry_point
(
) const
{
...
t_compound_transition_step::get_target_vertices
(
)
{
...
void
// cppcheck-suppress unusedFunction
t_compound_transition_step::execute_transition_behaviors
(
