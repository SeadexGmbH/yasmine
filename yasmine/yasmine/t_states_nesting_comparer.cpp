...
t_states_nesting_comparer::t_states_nesting_comparer() = default;


t_states_nesting_comparer::~t_states_nesting_comparer() = default;


bool t_states_nesting_comparer::operator()(	const i_state& p_lhs,	const i_state& p_rhs ) const
{
...
bool t_states_nesting_comparer::operator()(	const i_state* const p_lhs, const i_state* const p_rhs ) const
{
