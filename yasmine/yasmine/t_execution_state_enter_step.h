...
class t_execution_state_enter_step final: public i_execution_step
{
public:
	explicit t_execution_state_enter_step
	(
		i_state& p_state
	);
	...
	t_execution_state_enter_step
	(
		const t_execution_state_enter_step&
	) = delete;
