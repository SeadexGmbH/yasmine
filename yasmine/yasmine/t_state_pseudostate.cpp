...
t_state_pseudostate::t_state_pseudostate
(
...
t_state_pseudostate::get_parent
(
) const
{
...
i_composite_state&
t_state_pseudostate::get_parent_state
(
) const
{
	return( *m_parent );
...
void
t_state_pseudostate::set_parent_state
(
...
t_state_pseudostate::get_ancestors
(
...
t_raw_regions
t_state_pseudostate::get_ancestors_as_regions
(
) const
{
