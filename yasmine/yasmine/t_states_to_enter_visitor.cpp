...
t_states_to_enter_visitor::t_states_to_enter_visitor
(
	t_raw_states_by_nesting_level& p_states_to_enter,
	t_raw_const_region_set& p_regions_to_enter,
	i_composite_state& p_LCA_of_compound_transition	
):
...
void
t_states_to_enter_visitor::visit
(
...
void
t_states_to_enter_visitor::get_states_up_to_LCA
(
	i_state& p_state
)
{		
...
void
t_states_to_enter_visitor::get_regions_up_to_LCA
(
...
void
t_states_to_enter_visitor::add_last_active_child_states_to_enter
(
	const i_state& p_state
)
{
...
void
t_states_to_enter_visitor::insert_states_to_enter
(
	i_state& p_state
)
{
