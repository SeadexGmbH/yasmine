...
{
public:
	i_pseudostate_visitor() = default;
	virtual ~i_pseudostate_visitor() = default;
	i_pseudostate_visitor( const i_pseudostate_visitor& ) = delete;
	i_pseudostate_visitor& operator=( const i_pseudostate_visitor& ) = delete;
