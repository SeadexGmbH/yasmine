...
t_execution_state_exit_step::t_execution_state_exit_step
(
	i_state& p_state
):
	i_execution_step(),
...
bool
t_execution_state_exit_step::execute_behavior
(
...
void
t_execution_state_exit_step::accept
(
...
const i_state&
t_execution_state_exit_step::get_state
(
) const
{
	return ( m_state );
