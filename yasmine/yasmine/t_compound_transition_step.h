...
class t_compound_transition_step final:
	public i_transition_step
{
public:
	explicit t_compound_transition_step( const t_raw_transitions& p_transition_step );
	virtual ~t_compound_transition_step() override;
	t_compound_transition_step( const t_compound_transition_step& ) = delete;
	t_compound_transition_step& operator=( const t_compound_transition_step& ) = delete;
