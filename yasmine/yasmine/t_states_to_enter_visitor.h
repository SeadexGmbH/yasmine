...
class t_states_to_enter_visitor: public virtual i_vertex_visitor
{
public:
	t_states_to_enter_visitor
	(
	...
	t_states_to_enter_visitor
	(
		const t_states_to_enter_visitor&
	) = delete;
...
private:
	...
	void
	add_last_active_child_states_to_enter
	(
		const i_state& p_state
	);
