...
class t_composite_state: public virtual i_composite_state, public t_complex_state
{


public:
	explicit t_composite_state
	(			
	...
	virtual const i_deep_history*
	get_deep_history
	(
	) const override;


	virtual i_deep_history&
	add_deep_history
	(
	...
	virtual const t_raw_const_entry_points
	get_entry_points
	(
	) const override;


	virtual i_entry_point&
	add_entry_point
	(
	...
	virtual const t_raw_const_exit_points
	get_exit_points
	(
	) const override;


	virtual i_exit_point&
	add_exit_point
	(
...
private:
	virtual bool
	check_if_regions_are_completed
	(
	) const override;
