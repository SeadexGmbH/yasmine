...
class t_complex_state:
	public virtual i_complex_state, public t_state
{
public:
	explicit t_complex_state(	const std::string& p_name, i_behavior_uptr p_entry_behavior, 
		i_behavior_uptr p_exit_behavior, const t_event_ids& p_deferred_events = {} );
	virtual ~t_complex_state() override;
	t_complex_state( const t_complex_state& ) = delete;
	t_complex_state& operator=( const t_complex_state& ) = delete;
