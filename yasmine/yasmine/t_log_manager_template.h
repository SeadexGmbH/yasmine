...
public:
	...
	static t_log_manager_template& get_instance( void )
	{
	...
	t_log_manager_template( const t_log_manager_template& ) = delete;
	t_log_manager_template& operator=( const t_log_manager_template& ) = delete;
	...
	void log( const t_log_level p_log_level_message, const std::string& p_log_time_stamp,	const std::string& p_log_file,
		const int p_log_line,	const std::string& p_log_message, tt_args ... p_args )
	{
		{
			t_log_message l_message( p_log_level_message, p_log_time_stamp, p_log_file, p_log_line, sxy::yprintf(
																 p_log_message.c_str(), p_args ... ) );
	...
	// !\return void
	void add_logger( i_logger_uptr p_logger )
	{
