...
t_uri::t_uri( const std::string& p_uri )
	: m_uri()
{
...
bool t_uri::is_empty() const
{
	return( m_uri.empty() );
}


const std::string t_uri::to_string() const
{
	return( build_uri() );
}
...
// cppcheck-suppress unusedFunction
const std::string& t_uri::get_front() const
{
...
// cppcheck-suppress unusedFunction
const std::string& t_uri::get_back()
{
	Y_ASSERT( !m_uri.empty(), "Uri is empty!" );
	return( m_uri.back() );
}
...
void t_uri::push_front( const std::string& p_segment )
{
	m_uri.push_front( p_segment );
}


void t_uri::push_back( const std::string& p_segment )
{
	m_uri.push_back( p_segment );
}


void t_uri::pop_front()
{
	Y_ASSERT( !m_uri.empty(), "Uri is empty!" );
	m_uri.pop_front();
}
...
size_t t_uri::size() const
{
	return( m_uri.size() );
}


const std::string t_uri::build_uri() const
{
...
void t_uri::split_string_to_uri_segments( const std::string& p_uri )
{
