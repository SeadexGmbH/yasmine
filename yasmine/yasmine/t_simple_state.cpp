...
t_simple_state::t_simple_state
(
	const std::string& p_name,
	i_behavior_uptr do_action,
...
void
t_simple_state::accept_vertex_visitor
(
...
void
t_simple_state::accept_complex_state_visitor
(
...
void
t_simple_state::accept_state_visitor
(
...
void
t_simple_state::execute_do_behavior
(
