...
private:
	...
	static void minimutime_not_elapsed_();
	static void minimutime_elapsed_();
	static void minimutime_not_elapsed_farmroad_waiting_();
	...
	detector detector_;
	unsigned int farmroad_maximutime_event_handle_;
};
