...
t_traffic_light::t_traffic_light( const std::string& p_name, const std::string& p_ascii_prefix )
...
void t_traffic_light::build_traffic_light_state_machine()
{
	...
	m_traffic_light_state_machine.add_transition( "switch_to_red_yellow", g_event_switch_to_red_yellow, l_red_state,
		l_red_yellow_state );
	m_traffic_light_state_machine.add_transition( "switch_to_green", g_event_switch_to_green, l_red_yellow_state,
		l_green_state );
	m_traffic_light_state_machine.add_transition( "switch_to_yellow", g_event_switch_to_yellow, l_green_state,
		l_yellow_state );
	m_traffic_light_state_machine.add_transition( "switch_to_red", g_event_switch_to_red, l_yellow_state, l_red_state );
}


std::string t_traffic_light::display_road_name_with_ascii_prefix() const
{
